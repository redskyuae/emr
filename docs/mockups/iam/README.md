# User & Role Management (IAM) — UI Mockups

Reference screenshots for the User & Role Management frontend tasks (TASK-025 … TASK-030).

These are rendered from the **Vitals EMR** Claude Design handoff bundle (design id `8616a9e2`),
which was generated from this repository. They are **layout/visual references only**. The actual
screens must be rebuilt with the project's own design system — shadcn/ui components and the Fluent
