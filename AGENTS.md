...
Read `CLAUDE.md` for the full project architecture, coding conventions, module structure, and multi-tenancy rules. Read `CONTEXT.md` for the canonical domain glossary — use those terms exactly.
