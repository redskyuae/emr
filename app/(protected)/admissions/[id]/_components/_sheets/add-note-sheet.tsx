...
import {
  admissionNoteFormSchema,
  type AdmissionNoteFormValues,
} from '../../_utils/admission-capture-form-schema';

const EMPTY: AdmissionNoteFormValues = {
  noteTypeId: '',
  subjective: '',
  objective: '',
  assessment: '',
...
export function AddNoteSheet({
  ...
  const form = useForm<AdmissionNoteFormValues>({
    ...
    <Sheet open={open} onOpenChange={(next) => (!next ? onClose() : undefined)}>
      ...
      >
        <SheetHeader className="border-b p-4 pr-12">
          ...
          <SheetDescription>
            Authored against this Admission and saved as a draft. Sign it from the Patient Chart.
          </SheetDescription>
        </SheetHeader>
