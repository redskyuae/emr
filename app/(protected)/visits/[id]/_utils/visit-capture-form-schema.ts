...
export const visitVitalsFormSchema = z.object({
...
export const visitNoteFormSchema = z
  .object({
...
export type VisitVitalsFormValues = z.infer<typeof visitVitalsFormSchema>;
export type VisitNoteFormValues = z.infer<typeof visitNoteFormSchema>;
