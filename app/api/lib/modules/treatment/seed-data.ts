...
export const DEFAULT_TREATMENTS: CreateTreatmentInput[] = [
  ...
  },
  {
    ...
    sessions: [1, 2].map((sessionNumber) => ({
      sessionNumber,
      label: `Session ${sessionNumber} of 2 · Shirodhara`,
      ...
      warning: 'Stop if the Patient reports dizziness or discomfort at the forehead.',
      equipment: 'Dhara pot, warm herbal oil, towels, reclining table',
      roomType: 'Therapy room',
      therapistSkill: 'Shirodhara',
    })),
  },
