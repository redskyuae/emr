...
export type DeleteAppointmentCancelledReasonInput = {
  id: number;
  tenantId: string;
};

export function validateDeleteAppointmentCancelledReason(
  id: unknown,
  tenantId: unknown
): ValidationResult<DeleteAppointmentCancelledReasonInput> {
