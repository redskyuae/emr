...
export async function deactivatePatientCommand(
  id: unknown,
  tenantId: string
  ...
  const deactivatedPatient = await patientRepository.setPatientActive(
  ...
  return { success: true, data: deactivatedPatient };
}
