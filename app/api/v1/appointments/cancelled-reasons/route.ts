...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await createAppointmentCancelledReasonCommand(payload, tenantSession.tenantId);
    ...
    return NextResponse.json<SaveAppointmentCancelledReasonResponse>(
      { data: result.data },
